...
#
        ...
        self.demodFilterSize.setMinimum(1000)
        self.demodFilterSize.setMaximum(119000)
        self.demodFilterSize.setSingleStep(1)
        self.demodFilterSize.setProperty("value", 100000)
        self.demodFilterSize.setOrientation(QtCore.Qt.Horizontal)
        self.demodFilterSize.setTickPosition(QtGui.QSlider.TicksBelow)
        self.demodFilterSize.setTickInterval(10000)
...
#####````````
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.demodFiltSizeLabel.setText(_translate("MainWindow", "100000", None))
